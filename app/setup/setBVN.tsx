...
const SetBVN = ({toggleBVN, setStep2, isSuccess, isFailed, setMessage }:any) => {
  ...
  return renderForm(
    <Box style={Styles.martContainer} alignItems={'center'} justifyContent={'center'}>
        ...
        <Box marginTop={'xl'} height={40} justifyContent={'center'} >
                ...
                <Box marginTop={'lg'}>
                      <CustomTextInput name='bvn' placeholder='Enter your BVN'  label='BVN' keyboardType="number-pad"
