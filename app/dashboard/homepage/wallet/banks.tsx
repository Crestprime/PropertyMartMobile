    ...
    <Box flex={1} paddingHorizontal={'md'} bg={'white'}>
        ...
        {banks.length < 1 && (
            <Box flex={1} alignItems={'center'} justifyContent={'center'}>
                ...
                <RoundedButton label='Add Bank' onPress={() => router.push('/dashboard/homepage/wallet/addbank')} width={'100%'} height={48} borderRadius={10} backgroundColor={theme.colors.primaryColor} textColor='white' />
            </Box>
        )}
