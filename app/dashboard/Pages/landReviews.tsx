...
export default function setupAccount() {
  ...
  const ratings = [
    { id:1, title:'Transactions', rate:'4.5' },
    { id:2, title:'Communication', rate:'2.5' },
    { id:3, title:'Property Value', rate:'4.5' },
    { id:4, title:'Location', rate:'2.0' },
    { id:5, title:'Legal/Paper Work', rate:'1.0' },
  ]
              ...
              <Box height={'60%'}>
                  ...
                  <Box height={30} flexDirection={'row'}>
                      ...
                      <Box width={'40%'} justifyContent={'center'}>
                        <PrimaryButton label='Give Feedback' onPress={()=>window.alert('feedBack')} width={'100%'}/>
                      </Box>
                  </Box>
                  <Box marginTop={'xs'}>
